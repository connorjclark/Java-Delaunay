...
import hoten.delaunay.geom.Rectangle;
import hoten.delaunay.voronoi.nodename.as3delaunay.LineSegment;
...
public abstract class VoronoiGraph {
    ...
    private void buildGraph(Voronoi v) {
        ...
        final ArrayList<hoten.delaunay.voronoi.nodename.as3delaunay.Edge> libedges = v.edges();
        final HashMap<Integer, Corner> pointCornerMap = new HashMap();

        for (hoten.delaunay.voronoi.nodename.as3delaunay.Edge libedge : libedges) {
